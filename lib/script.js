...
var car2 = new Car("BMW", "M3", 2010, 10000, " grey");
...
function mostDrivenCar() {
    ...
    for (var i = 1, len = Car.length; i <= len; i++) {
        ...
        if (carKM1 == kmPerYear1) {
            ...
            document.getElementById("maxKM").innerHTML = car1.brand + " " + carKM1 + "<br>";
        }
        else if (carKM2 == kmPerYear1) {
            console.log(car2.brand + " " + carKM2);
            document.getElementById("maxKM").innerHTML = car2.brand + " " + carKM2 + "<br>";
        }
        else {
            console.log(car3.brand + " " + carKM3);
            document.getElementById("maxKM").innerHTML = car3.brand + " " + carKM3 + "<br>";
        }
    }
    // console.log(carKM1);
    // console.log(carKM2);
...
function enterNewCar() {
    car4.brand = document.getElementById("brand11").value;
    car4.model = document.getElementById("model1").value;
    car4.mYear = document.getElementById("mYear1").value;
    car4.km = document.getElementById("km1").value;
    car4.color = document.getElementById("color1").value;
